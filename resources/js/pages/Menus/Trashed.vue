                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0">Menus Trashed Table</h4>
                            ...
                            <div class="card-body">
                                <div class="dropdown float-end">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <a @click="$refs.FormModal.restore(menu.id)" class="dropdown-item dropdownItem" href="javascript:;">
                                            <i class="fa-solid fa-rotate-left"></i> restore
                                        </a>
                                        <a @click="$refs.FormModal.forceDestroy(menu.id)" class="dropdown-item dropdownItem" href="javascript:;">
...
export default {
    ...
    methods: { 
        fetchData(num = 1) {
            ...
            axios.get('menus/trashed', data).then(({ data }) => {
