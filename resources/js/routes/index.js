    ...
    routes: [
        {
            ...
            children: [
                ...
                //#Vue:Routes
		        {path:'renewals',name: 'renewals',component:()=>import('../pages/Products/Index'),meta:{title: 'Renewals',middleware: [auth, checkAuth]} },
		        ...
		        {path:'promo',name: 'promo',component:()=>import('../pages/Promo/Index'),meta:{title: 'Promo Codes',middleware: [auth, checkAuth]} },
