    ...
    <nav class="navbar navbar-expand-xl navbar-{{(Route::currentRouteName()=='home')?'dark':'light'}} sticky-header">
        <div class="container d-flex align-items-center justify-content-lg-between position-relative">
            ...
            <div class="action-btns text-end me-5 me-lg-0 d-none d-md-block d-lg-block">
                <a href="{{ LaravelLocalization::localizeUrl('/login') }}" class="btn btn-link text-decoration-none me-2 ar-font">@lang('header.sign_in')</a>
                <a href="{{ LaravelLocalization::localizeUrl('/register') }}" class="btn btn-primary ar-font">@lang('header.get_started')</a>                
            </div>
            @endif
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasWithBackdrop">
                ...
                <div class="offcanvas-body">
                    ...
                    <div class="action-btns mt-4 ps-3">
                        <a href="{{ LaravelLocalization::localizeUrl('/login') }}" class="btn btn-outline-primary me-2 ar-font">@lang('header.sign_in')</a>
                        <a href="{{ LaravelLocalization::localizeUrl('/register') }}" class="btn btn-primary ar-font">@lang('header.get_started')</a>
                    </div>
                    @endif
                </div>
