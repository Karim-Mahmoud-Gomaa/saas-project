...
@section('title') @lang('webcompany::log.signup.page_title') @endsection
            ...
            <div class="col-lg-10 col-12">
                <div class="pricing-content-wrap bg-custom-light rounded-custom shadow-lg">
                    ...
                    <div class="price-feature-col pricing-action-info p-5 right-radius bg-light order-0 order-lg-1">
                        ...
                        <h1 class="h3 ar-font rtl text-center">@lang('webcompany::log.signup.title')</h1>
                        <p class="text-muted ar-font rtl text-center">@lang('webcompany::log.signup.body')</p>
                        
                        <form action="{{asset('webcompany/signup')}}" method="POST" class="mt-4 register-form">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                    <label for="name" class="mb-1 ar-font rtl float-{{($lang=='ar')?'end':'start'}}">@lang('webcompany::log.name') <span class="text-danger">*</span></label>
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" placeholder="{{__('webcompany::log.name')}}" id="name" required aria-label="name">
                                    </div>
                                </div>
                                <div class="col-sm-6 ">
                                ...
                                <div class="col-sm-12">
                                    <label for="company" class="mb-1 ar-font rtl float-{{($lang=='ar')?'end':'start'}}">@lang('webcompany::log.company')</label>
                                    <div class="input-group mb-3">
                                        <input type="text" class="form-control" placeholder="{{__('webcompany::log.company')}}" id="company" required aria-label="company">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                ...
                                <div class="col-12">
                                    <div class="form-check d-flex">
                                        ...
                                        <label class="form-check-label ar-font rtl" for="flexCheckChecked">
                                            @lang('webcompany::log.i_read')
                                            <a href="#" class="text-decoration-none">@lang('webcompany::log.terms_conditions')</a>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary mt-4 d-block w-100 ar-font text-center">@lang('webcompany::log.signup.page_title')</button>
                                </div>
                            </div>
                            ...
                            <p class="text-center text-muted mt-4 mb-0 fw-medium font-monospace ar-font">
                                @lang('webcompany::log.have_account')
                                <a href="{{ LaravelLocalization::localizeUrl('login') }}" class="text-decoration-none">@lang('webcompany::log.login.page_title')</a>
                            </p>
                        </form>
                    </div>
                </div>
