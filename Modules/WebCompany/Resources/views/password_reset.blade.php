...
@section('title') @lang('webcompany::log.reset.page_title') @endsection
        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-lg-5 col-md-8 col-12">
                ...
                <div class="register-wrap p-5 bg-light shadow rounded-custom">
                    <h1 class="fw-bold h3 ar-font rtl text-center">@lang('webcompany::log.reset.title')</h1>
                    <p class="text-muted ar-font rtl text-center">@lang('webcompany::log.reset.body')</p>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="input-group mb-3">
                                    <input type="email" class="form-control" placeholder="{{__('webcompany::log.reset.enter')}}" id="email" required aria-label="email">
                                </div>
                            </div>
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary mt-3 d-block w-100 ar-font text-center">@lang('webcompany::log.reset.page_title')</button>
                            </div>
                        </div>
                        <p class="font-monospace fw-medium text-center mt-3 pt-4 mb-0">
                            <a href="{{ LaravelLocalization::localizeUrl('login') }}" class="text-decoration-none ar-font">@lang('webcompany::log.reset.back')</a>
                        </p>
                    </form>
                </div>
            </div>
