...
class MakePartialComponenetCommand extends Command
{
    /**
     * Custom variables
     */
     ...
     * @var string
     */
    protected $name = 'builder:make-partial';
     ...
     * @var string
     */
    protected $description = 'Creates a PageBuilder partial component.';
    ...
    protected function createComponent(){
        $component = $this->themeName.'/partials/'.$this->componenetName;
